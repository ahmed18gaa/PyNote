...
if (macDownload) {
  macDownload.href =
    "https://github.com/ahmed18gaa/PyNote/releases/download/v1.0.0/PyNote-1.0.0.dmg";
}

if (windowsDownload) {
  windowsDownload.href =
    "https://github.com/ahmed18gaa/PyNote/releases/download/v1.0.0/PyNote-Windows.zip";
}
